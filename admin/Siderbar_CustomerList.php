...
$result = $conn->query("SELECT COUNT(*) AS total FROM user $searchQuery");
$totalRecords = $result->fetch_assoc()['total'];
$totalPages = ceil($totalRecords / $recordsPerPage);

$customers = $conn->query("SELECT * FROM user $searchQuery LIMIT $startFrom, $recordsPerPage");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($id > 0) {
        $sql = "UPDATE user SET user_name='$name', email='$email', user_phone_num='$phone' WHERE user_id=$id";
    } else {
        $sql = "INSERT INTO user (user_name, email, user_phone_num) VALUES ('$name', '$email', '$phone')";
    }
...
<body>
    <div class="dashboard-container">
        ...
        <main class="main-content">
            ...
            <button class="add-btn" onclick="showForm()">+ Add New User</button>
            ...
            <script>
                function showForm() {
                    ...
                    document.getElementById("user_phone_num").value = "";
                }
